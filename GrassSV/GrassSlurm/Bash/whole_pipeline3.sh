...
do
	...
	do
		...
		#GrassSV.py find_sv ${data}/coverage_${coverage}_${margin}/${assembler}/quast/contigs_reports/all_alignments_contigs.tsv -o ${data}/coverage_${coverage}_${margin}/${assembler}/
	done
done
